...
const textTranslations = {
  ...
  "Español": "Spanish",
  "English": "English",
  "Plataforma premium de dedicatorias digitales": "Premium digital dedication platform",
  "Dedicatorias interactivas para momentos inolvidables": "Interactive dedications for unforgettable moments",
  "Crea páginas privadas con fotos, música, mensajes y animaciones. Comparte un enlace elegante para aniversarios, cumpleaños, San Valentín o cualquier sorpresa especial.": "Create private pages with photos, music, messages, and animations. Share an elegant link for anniversaries, birthdays, Valentine's Day, or any special surprise.",
  ...
  "Experiencias con animaciones y efectos visuales.": "Experiences with animations and visual effects.",
  "Fácil de compartir": "Easy to share",
  "Entrega tu dedicatoria con un enlace privado.": "Deliver your dedication with a private link.",
  "Personalización completa": "Full customization",
  "Nombres, fotos, música, mensajes y contraseña.": "Names, photos, music, messages, and password.",
  "Simple y rápido": "Simple and fast",
  "¿Cómo funciona?": "How does it work?",
  "Crea tu página de dedicatoria en tres simples pasos": "Create your dedication page in three simple steps",
  "Paso 1": "Step 1",
  "Paso 2": "Step 2",
  "Paso 3": "Step 3",
  "Elige una plantilla": "Choose a template",
  "30+ plantillas interactivas con animaciones y estilos para cada ocasión.": "30+ interactive templates with animations and styles for every occasion.",
  "Personaliza tu página": "Customize your page",
  "Agrega fotos, mensajes, nombres y contraseña para proteger tu dedicatoria.": "Add photos, messages, names, and a password to protect your dedication.",
  "Comparte con tu persona especial": "Share it with your special person",
  "Comparte el enlace por WhatsApp o redes sociales y sácale una sonrisa.": "Share the link through WhatsApp or social media and make them smile.",
  ...
  "Crea una dedicatoria única para celebrar momentos especiales.": "Create a unique dedication to celebrate special moments.",
  "Crear página": "Create page",
  "Ver plantilla": "View template",
  "Caja de Chocolates de Amor": "Love Chocolate Box",
  "Caja interactiva con mensajes ocultos y sorpresa final.": "Interactive box with hidden messages and a final surprise.",
  "Caja de chocolates interactiva con mensajes ocultos.": "Interactive chocolate box with hidden messages.",
  "Galaxia del Amor": "Love Galaxy",
  "Universo visual con estrellas, corazón central y movimiento.": "Visual universe with stars, a central heart, and motion.",
  "Hoyo negro, anillo de acreción y estrellas flotantes.": "Black hole, accretion ring, and floating stars.",
  "Universo del Amor": "Love Universe",
  "Universo 3D girando con foto, música y mensaje central.": "Spinning 3D universe with photo, music, and central message.",
  "Universo 3D girando con foto y música.": "Spinning 3D universe with photo and music.",
  "Carta Animada": "Animated Letter",
  "Una carta digital con apertura suave y mensaje dedicado.": "A digital letter with a soft opening and dedicated message.",
  "Suscripciones": "Subscriptions",
  "Planes para cada dedicatoria": "Plans for every dedication",
  "Empieza gratis y sube a Premium o VIP cuando quieras más efectos y personalización.": "Start free and upgrade to Premium or VIP when you want more effects and customization.",
  "Gratis": "Free",
  "/ prueba": "/ trial",
  ...
  "¿Listo para sorprender a alguien especial?": "Ready to surprise someone special?",
  "Crea una página de dedicatoria única que nunca olvidará. Empieza ahora, solo toma unos minutos.": "Create a unique dedication page they will never forget. Start now, it only takes a few minutes.",
  "Crear Mi Dedicatoria": "Create My Dedication",
  "Crea dedicatorias digitales memorables con plantillas interactivas, música, fotos y enlaces privados.": "Create memorable digital dedications with interactive templates, music, photos, and private links.",
  "Navegación": "Navigation",
  "Cuenta": "Account",
  "Contacto": "Contact",
  "Soporte": "Support",
  "© 2026 DEV AGS. Todos los derechos reservados.": "© 2026 DEV AGS. All rights reserved.",
  ...
  "Árbol animado con contador de tiempo, carta sorpresa y carrusel de fotos.": "Animated tree with timer, surprise letter, and photo carousel.",
  "Galaxy Gallery": "Galaxy Gallery",
  "Una galería 3D dentro de una galaxia con agujero negro y partículas.": "A 3D gallery inside a galaxy with a black hole and particles.",
  "Latidos de Luz": "Light Beats",
  "Un corazón 3D animado con texto que late, fotos en burbujas y música.": "An animated 3D heart with pulsing text, bubble photos, and music.",
  "Netflix de Amor": "Love Netflix",
  "Crea tu propia serie de amor estilo Netflix con perfiles, episodios y video.": "Create your own Netflix-style love series with profiles, episodes, and video.",
  "Corazón Galáctico": "Galactic Heart",
  "Corazón galáctico con partículas, texto y fotos flotantes.": "Galactic heart with particles, text, and floating photos.",
  "Pregunta Romántica": "Romantic Question",
  "Haz una pregunta romántica de sí o no con una escena especial.": "Ask a romantic yes-or-no question with a special scene.",
  "El Camino Juntos": "The Path Together",
  "Un globo terráqueo 3D interactivo que une dos ciudades.": "An interactive 3D globe connecting two cities.",
  "Heart Shooter": "Heart Shooter",
  "Juego romántico heart shooter con mensajes finales.": "Romantic heart shooter game with final messages.",
  "Mostrando 12 de 30 plantillas": "Showing 12 of 30 templates",
  "Mi panel": "My dashboard",
  "Administra tus páginas, planes y pagos": "Manage your pages, plans, and payments",
  "Aún no tienes páginas": "You don't have pages yet",
  "Crea tu primera página personalizada en minutos": "Create your first personalized page in minutes",
...
const reverseTextTranslations = Object.fromEntries(
  Object.entries(textTranslations).map(([spanish, english]) => [english, spanish]),
);
...
const reversePlaceholderTranslations = Object.fromEntries(
  Object.entries(placeholderTranslations).map(([spanish, english]) => [english, spanish]),
);
...
const translateTextContent = (language) => {
  const dictionary = language === "en" ? textTranslations : reverseTextTranslations;
...
const applyLanguage = (language) => {
  ...
  document.querySelectorAll(".dashboard-language .mini-flag").forEach((flag) => {
...
const markActiveNavigation = () => {
  ...
  const activeKey = path.includes("/templates/")
    ...
    : path.includes("/my-pages/")
      ? "my-pages"
      : "home";
  document.querySelector(`[data-nav="${activeKey}"]`)?.classList.add("nav-active");
};
...
const initAuthForms = () => {
  document.querySelectorAll(".auth-form").forEach((form) => {
    form.addEventListener("submit", (event) => {
      ...
      if (isLoginPage && (email !== "amilgutysal@gmail.com" || password !== "12345")) {
        message.textContent =
      ...
      if (submit) {
        submit.textContent = localStorage.getItem("DEV AGS-language") === "en" ? "Done" : "Listo";
...
const initPanelTabs = () => {
  ...
  const activate = (target) => {
    tabs.forEach((tab) => tab.classList.toggle("active", tab.dataset.panelTab === target));
    contents.forEach((content) => {
      content.classList.toggle("active", content.dataset.panelContent === target);
    });
  };
  ...
  activate(["pages", "plans", "payments"].includes(initial) ? initial : "pages");
};
